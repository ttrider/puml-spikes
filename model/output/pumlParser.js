...
var symbolicNames = [ null, "STARTUML", "STARTUMLLINE", "ENDUML", "PARTICIPANT", 
                      ...
                      "DBLQUOTE", "ESC_DBLQUOTE", "SPACE", "CR", "HEX_COLORS", 
                      "NAMED_COLORS", "ANY" ];
...
pumlParser.ESC_DBLQUOTE = 32;
pumlParser.SPACE = 33;
pumlParser.CR = 34;
pumlParser.HEX_COLORS = 35;
pumlParser.NAMED_COLORS = 36;
pumlParser.ANY = 37;
...
pumlParser.RULE_participant = 36;
pumlParser.RULE_identifier = 37;
pumlParser.RULE_quotedIdentifier = 38;
    ...
    try {
        ...
        while(_alt!=1 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1+1) {
                this.state = 294;
                _la = this._input.LA(1);
                if(!(((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (pumlParser.SPACE - 33)) | (1 << (pumlParser.CR - 33)) | (1 << (pumlParser.ANY - 33)))) !== 0))) {
                this._errHandler.recoverInline(this);
                }
                else {
                	this._errHandler.reportMatch(this);
...
DeclareParticipantContext.prototype.SPACE = function() {
    return this.getToken(pumlParser.SPACE, 0);
};
...
pumlParser.prototype.participant = function() {
    ...
    this.enterRule(localctx, 72, pumlParser.RULE_participant);
    try {
        this.state = 367;
        this._errHandler.sync(this);
...
pumlParser.prototype.identifier = function() {
    ...
    this.enterRule(localctx, 74, pumlParser.RULE_identifier);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 372;
...
pumlParser.prototype.quotedIdentifier = function() {
    ...
    this.enterRule(localctx, 76, pumlParser.RULE_quotedIdentifier);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 375;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << pumlParser.STARTUML) | (1 << pumlParser.STARTUMLLINE) | (1 << pumlParser.ENDUML) | (1 << pumlParser.PARTICIPANT) | (1 << pumlParser.ACTOR) | (1 << pumlParser.BOUNDARY) | (1 << pumlParser.CONTROL) | (1 << pumlParser.ENTITY) | (1 << pumlParser.DATABASE) | (1 << pumlParser.COLLECTIONS) | (1 << pumlParser.NOTE) | (1 << pumlParser.RNOTE) | (1 << pumlParser.HNOTE) | (1 << pumlParser.LEFT) | (1 << pumlParser.RIGHT) | (1 << pumlParser.OVER) | (1 << pumlParser.ENDNOTE) | (1 << pumlParser.ENDRNOTE) | (1 << pumlParser.ENDHNOTE) | (1 << pumlParser.END_NOTE) | (1 << pumlParser.END_RNOTE) | (1 << pumlParser.END_HNOTE) | (1 << pumlParser.OF) | (1 << pumlParser.CONNECTOR_SINGLE_LEFT) | (1 << pumlParser.CONNECTOR_SINGLE_RIGHT) | (1 << pumlParser.CONNECTOR_DOUBLE_LEFT) | (1 << pumlParser.CONNECTOR_DOUBLE_RIGHT) | (1 << pumlParser.SEMICOLON) | (1 << pumlParser.COLON) | (1 << pumlParser.COMMA))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (pumlParser.ESC_DBLQUOTE - 32)) | (1 << (pumlParser.SPACE - 32)) | (1 << (pumlParser.CR - 32)) | (1 << (pumlParser.HEX_COLORS - 32)) | (1 << (pumlParser.NAMED_COLORS - 32)) | (1 << (pumlParser.ANY - 32)))) !== 0)) {
            this.state = 378;
            this._errHandler.sync(this);
